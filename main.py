...
API_ID = int(os.environ.get("API_ID", 2695501))
API_HASH = os.environ.get("API_HASH", "9a544068ea55f54ca7725245d0e8f0f9")
BOT_TOKEN = os.environ.get("BOT_TOKEN", "7876227653:AAEl1CpmAk5zYK4qEaYwv3vr1CyYW4cyLUY")
